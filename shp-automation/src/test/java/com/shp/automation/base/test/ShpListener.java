...
public class ShpListener extends TestListenerAdapter{

	public static final Logger logger = LogManager.getLogger(ShpListener.class);
	//On start
	@Override
	...
	//On success
		...
		public void onTestSuccess(ITestResult tr) {
			...
			TakesScreenshot scrShot = ((TakesScreenshot) ShpBaseTest.driver);
